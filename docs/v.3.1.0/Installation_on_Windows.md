...
> **File:** `installers/v.3.1.0/dx_rt_windows_driver_v1.8.0_x86_64.exe`
...
If the device is not connected or not recognized, you will see the following screen:

![Device Not Found](./../resources/windows_driver_is_not_installed.png)
...
![Device Found](./../resources/windows_driver_is_installed.png)
...
> **File:** `prebuilt/v3.1.0/dx_rt_windows_prebuilt_v3.1.0_x86_64.zip`
...
1.  Right-click `dxrtd.exe` in the extracted folder and select **Create shortcut**.
...
2.  Navigate to the directory where you extracted the prebuilt files.
